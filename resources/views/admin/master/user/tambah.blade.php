                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="First Name" id="name" name="name" required
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" id="password" class="form-control"
                                                            name="password_confirmation" placeholder="Masukan Password" type="password" required value="{{ old('password', isset($user) ? $user->password : '') }}">
                                                    </div>
                                                </div>
